...
class TestFrac(unittest.TestCase):
    ...
    def test_add(self):
        self.assertEqual(self.f1.__add__(self.f0), Frac(1, 2))
        self.assertEqual(self.f2.__add__(self.f3), Frac(11, 30))
        self.assertEqual(self.f1.__add__(self.f2), Frac(1, 6))

    def test_sub(self):
        self.assertEqual(self.f1.__sub__(self.f0), Frac(1, 2))
        self.assertEqual(self.f2.__sub__(self.f3), Frac(-31, 30))
        self.assertEqual(self.f1.__sub__(self.f2), Frac(5, 6))

    def test_mul(self):
        self.assertEqual(self.f1.__mul__(self.f0), Frac(0, 1))
        self.assertEqual(self.f2.__mul__(self.f3), Frac(-7, 30))
        self.assertEqual(self.f1.__mul__(self.f2), Frac(-1, 6))
    ...
    def test_truediv(self):
        self.assertEqual(self.f2.__truediv__(self.f3), (-1 / 3) / (7 / 10))
        self.assertEqual(self.f3.__truediv__(self.f1), (7 / 10) / (3 / 6))
